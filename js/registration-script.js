...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function updateDueDate() {
        // Requirement: Date of joining school (Start Date) -> Payment Date -> Due Date
    ...
    function collectData() {
        ...
        return {
            ...
            dueDate: getValue('reg_dueDate'),
            // nextDueDate removed as requested
            endDate: getValue('reg_endDate'),
    ...
    async function loadStudentForEdit(key) {
        ...
        if (snap.exists()) {
            ...
            setDateValue('reg_endDate', d.endDate);
            calculateTotal();
        }
    }
    ...
    function resetForm() {
        ...
        const customStudyTimeContainer = document.getElementById('customStudyTimeContainer');
        if (customStudyTimeContainer) customStudyTimeContainer.style.display = 'none';
        ...
        if (formTitle) formTitle.textContent = "ចុះឈ្មោះសិស្សថ្មី";
    ...
    const studyTimeSelect = document.getElementById('reg_studyTime');
    if (studyTimeSelect) {
        studyTimeSelect.addEventListener('change', function () {
            ...
            if (this.value === 'custom') {
                ...
                // Add snappy animation
                customContainer.classList.remove('animate__fadeIn');
                void customContainer.offsetWidth; // trigger reflow
                customContainer.classList.add('animate__fadeIn');

                const customInput = document.getElementById('reg_customStudyTime');
